...
query="SELECT HOUR(fechacompra) as HORA, WEEK(fechacompra) as SEMANA, COUNT(DISTINCT factura) as VENTAS FROM sales GROUP BY HOUR(fechacompra), WEEK(fechacompra);" #query de sql obtiene una tabla con factura y el conteo de los SKU (Ventas por país)
