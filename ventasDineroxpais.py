...
query="SELECT pais, sum(cantidad*precioventa) as cantidad FROM sales GROUP BY pais;" #query de sql obtiene una tabla con factura y el conteo de los SKU (Ventas por país)
